...
describe('The app ', () => {
  ...
  test('it fetches and renders all products on the page mock data', async () => {
  ...
  test('it fetches and renders all products on the page fake data', async () => {
    mockAxios.get.mockResolvedValue({
  ...
  test('it can open and close the filters panel', async () => {
    const { getByText, queryByText, queryByTestId } = setupApp()
    ...
    const closeButton = queryByTestId(/closecanvas/i)
